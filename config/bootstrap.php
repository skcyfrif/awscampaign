...
//$siteName = 'http://' . $domain . '/2020/classified/';
$siteName = $domain . '/myapp/';
define('HTTP_ROOT', $siteName);
define('SITE_NAME', "Eslfast");
define('SITE_SHORT_NAME', "EF");
define('SITE_LONG_NAME', "eslfast");
define('CURDT', date('Y-m-d h:i:s'));
define('CURD', date('Y-m-d'));
define('USERIMAGE', 'img/uploads');

//FOR ENABLE DEBUGKIT IN SERVER
 if (Configure::read('debug')) {
