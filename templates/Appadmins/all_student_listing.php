                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="title-1">All Student List </h3>                        
                        </div>
                        <div class="card-body">
                                ...
                                <tbody id="list">
                                    ...
                                    foreach ($allData as $key => $data) { 
                                        ...
                                        <tr id="arrayorder_<?php echo $data->id; ?>" class="message_box ui-sortable-handle">
                                            ...
                                            <td valign="middle"><?= $data->reg_no;?></td>
                                            ...
                                            <td valign="middle">
                                                <?php if ($data->active_status == 2) { ?>
                                                    <a href="<?= HTTP_ROOT . 'appadmins/all_student_listing/absent/' . $data->id; ?>" class="btn btn-danger" title="Click to mark as present">Absent</a>
                                                <?php } else { ?>
                                                    <a href="<?= HTTP_ROOT . 'appadmins/all_student_listing/absent/' . $data->id; ?>" class="btn btn-success" title="Click to mark as absent">Present</a>
                                                <?php } ?>
                                            </td>                   
                                        </tr>
                                    <?php } ?>
...
<!-- Initialize DataTables and enable search functionality -->
<script>
    $(document).ready(function() {
        // Initialize DataTables
        $('#example1').DataTable({
            "dom": '<"top"f>rt<"bottom"p><"clear">',  // 'f' specifies where to show the search box
            "language": {
                "search": "Search student records:" // Customize the search placeholder text
            },
